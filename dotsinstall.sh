...
"3")
echo "You may need to cd into the directory and run pacman -U manually to the zst file due toname changes."

git clone https://aur.archlinux.org/aura-bin.git ~/Downloads/aura-bin
cd ~/Downloads/aura-bin
makepkg
aurazst='ls | grep .zst'
sudo pacman -U $aurazst
